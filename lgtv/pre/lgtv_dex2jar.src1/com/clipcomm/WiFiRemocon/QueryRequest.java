...
public class QueryRequest
{
  ...
  public static boolean GetCurrentChannel(LifeTime.DestInfo paramDestInfo, ChannelInfo paramChannelInfo)
  {
  ...
  public static boolean GetCurrentChannel(String paramString1, String paramString2, ChannelInfo paramChannelInfo)
  {
    boolean bool;
  ...
  public static boolean getFavoriteChannelPacket(LifeTime.DestInfo paramDestInfo)
  {
    boolean bool;
  ...
  public static boolean getFavoriteChannelPacket(String paramString1, String paramString2)
  {
    m_strDNFAVChannel = null;
    HTTPGet localHTTPGet = new HTTPGet();
  ...
  public static enum ui_state_token
  {
    static
    {
