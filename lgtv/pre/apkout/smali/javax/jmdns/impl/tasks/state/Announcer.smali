...
.method public constructor <init>(Ljavax/jmdns/impl/JmDNSImpl;)V
    ...
    .line 31
    #p0=(Reference,Ljavax/jmdns/impl/tasks/state/Announcer;);
    ...
    iput-object v0, p0, Ljavax/jmdns/impl/tasks/state/Announcer;->taskState:Ljavax/jmdns/impl/constants/DNSState;
...
.method public run()V
    ...
    .line 97
    :cond_2
    #v0=(Uninit);v1=(Uninit);v2=(Uninit);v3=(Uninit);v5=(Uninit);v6=(Boolean);v7=(Uninit);v8=(Uninit);v9=(Uninit);
    invoke-virtual {p0}, Ljavax/jmdns/impl/tasks/state/Announcer;->getDns()Ljavax/jmdns/impl/JmDNSImpl;
    ...
    iget-object v8, p0, Ljavax/jmdns/impl/tasks/state/Announcer;->taskState:Ljavax/jmdns/impl/constants/DNSState;
    ...
    .line 101
    sget-object v7, Ljavax/jmdns/impl/tasks/state/Announcer;->logger:Ljava/util/logging/Logger;

    #v7=(Reference,Ljava/util/logging/Logger;);
    new-instance v8, Ljava/lang/StringBuilder;

    #v8=(UninitRef,Ljava/lang/StringBuilder;);
    invoke-virtual {p0}, Ljavax/jmdns/impl/tasks/state/Announcer;->getName()Ljava/lang/String;
    ...
    const-string v9, ".run() JmDNS announcing host"
    ...
    .line 128
    sget-object v6, Ljavax/jmdns/impl/tasks/state/Announcer;->logger:Ljava/util/logging/Logger;
    ...
    const-string v8, ".run() JmDNS announcing #"
    ...
    iget-object v6, p0, Ljavax/jmdns/impl/tasks/state/Announcer;->taskState:Ljavax/jmdns/impl/constants/DNSState;
    ...
    iput-object v6, p0, Ljavax/jmdns/impl/tasks/state/Announcer;->taskState:Ljavax/jmdns/impl/constants/DNSState;

    .line 144
    iget-object v6, p0, Ljavax/jmdns/impl/tasks/state/Announcer;->taskState:Ljavax/jmdns/impl/constants/DNSState;

    invoke-virtual {v6}, Ljavax/jmdns/impl/constants/DNSState;->isAnnouncing()Z
    ...
    #v6=(Reference,Ljavax/jmdns/impl/JmDNSImpl;);
    invoke-virtual {v6}, Ljavax/jmdns/impl/JmDNSImpl;->startRenewer()V
    ...
    :cond_4
    :try_start_3
    #v0=(Uninit);v2=(Uninit);v3=(Uninit);v5=(Uninit);v7=(Reference,Ljava/util/Iterator;);v8=(Boolean);v9=(Reference,Ljava/lang/String;);
    ...
    #v8=(Null);
    invoke-virtual {p0, v4, v8, v1}, Ljavax/jmdns/impl/tasks/state/Announcer;->addAnswer(Ljavax/jmdns/impl/DNSOutgoing;Ljavax/jmdns/impl/DNSIncoming;Ljavax/jmdns/impl/DNSRecord;)Ljavax/jmdns/impl/DNSOutgoing;
    ...
    .line 115
    :try_start_6
    iget-object v7, p0, Ljavax/jmdns/impl/tasks/state/Announcer;->taskState:Ljavax/jmdns/impl/constants/DNSState;
    ...
    #v8=(Reference,Ljava/lang/StringBuilder;);
    const-string v9, ".run() JmDNS announcing "
...
.method public start(Ljava/util/Timer;)V
    ...
    #v1=(Reference,Ljavax/jmdns/impl/tasks/state/Announcer;);
    move-wide v4, v2
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Ljavax/jmdns/impl/tasks/state/Announcer;->taskState:Ljavax/jmdns/impl/constants/DNSState;
